...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/recycle-prices/types").permitAll()
                ...
                .requestMatchers(HttpMethod.POST, "/api/valuation/**").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/valuation/**").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/material-templates/**").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/admin/vehicle-dismantle").hasAnyRole("ADMIN", "OPERATOR")
                .requestMatchers(HttpMethod.GET, "/api/admin/vehicle-dismantle/**").authenticated()
